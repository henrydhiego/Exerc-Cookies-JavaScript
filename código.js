document.addEventListener('DOMContentLoaded', function() {
    ...
    if (cookie_place !== "accepted") {
        let consentElement = document.getElementById('cookie_place');
        if (consentElement) {
    ...
    document.getElementById('acceptCookies').addEventListener('click', function() {
        ...
        document.getElementById('cookie_place').style.display = "none";
        loadFavorites();
    });
    ...
    function saveFavorites() {
        let checkboxes = document.querySelectorAll('.produtos input[type="checkbox"]');
        let favorites = [];
